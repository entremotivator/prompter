...
<style>
    ...
    * {
    ...
    /* Content wrapper - NO white background */
    .block-container {
...
if uploaded_file is not None:
    ...
    if gc:
        ...
        with form_tab:
            ...
            st.markdown("""
            <div style='background-color: rgba(255, 255, 255, 0.2); padding: 20px; border-radius: 15px; margin-bottom: 25px; border: 2px solid white;'>
    ...
    <div style='text-align: center; padding: 50px 20px;'>
        ...
        <p style='font-size: 1.1rem; color: white; margin: 20px 0;'>
